...
\begin{lstlisting}[caption={Excerpt from the implementation of PCM\_\textit{x}PP.
...
\begin{lstlisting}[caption={Excerpt from the implementation of ICM\_\textit{x}PP.
