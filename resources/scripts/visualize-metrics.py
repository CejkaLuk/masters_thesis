...
def main():
   ...
   # Input directories
   # metrics_dir = f"/home/lukas/github/decomposition-benchmark-log-files/LU_LUIterGPU/50-pivoting-matrices-rci-g01-g10/Decomposers/search_badEl_start_only_fallback_value_fb0cedd"
   # log_filepath = f"{metrics_dir}/metrics_benchmark_log_decomposers_fb0cedd_double.txt"
   ...
   # metrics_dir = f"{REPO_ROOT}/resources/ch03/bddcml-benchmarks/ICMxPP_metrics"
   # log_filepath = f"{metrics_dir}/benchmark_log_decomposers_poc_matrices_double_precision.txt"
   ...
   iterations_pivots_plot(matrix, pivots_per_section, output_dir, MATRIX_NAME, SAVE_FIGURE)
