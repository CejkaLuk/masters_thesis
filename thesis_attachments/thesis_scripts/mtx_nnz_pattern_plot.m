...
%% This script creates a plot of the nonzero element pattern of matrices based on their name in `MATRICES` stored
%% in an .mtx file in `directory`.
...
% State the matrices to visualize - must be exact file names
MATRICES = {"fp", "c-22"};
